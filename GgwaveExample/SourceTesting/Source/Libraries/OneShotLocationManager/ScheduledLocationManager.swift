...
@objc protocol ScheduledLocationManagerDelegate {
...
public class ScheduledLocationManager : NSObject {
    ...
    var lastCapturedLocation: CLLocation? = nil
    ...
    override init() {
        ...
        notifCenter.addObserver(self, selector: #selector(applicationDidEnterBackground), name: UIApplication.didEnterBackgroundNotification, object: nil)
        notifCenter.addObserver(self, selector: #selector(applicationDidBecomeActive), name: UIApplication.didBecomeActiveNotification, object: nil)
...
//        locationManager.allowsBackgroundLocationUpdates = true
    ...
    fileprivate func updatedLocation(newLocation: CLLocation) {
        ...
        lastCapturedLocation = newLocation
    ...
    public func stopGettingUserLocation() {
        ...
        notifCenter.removeObserver(self, name: UIApplication.didEnterBackgroundNotification, object: nil)
        notifCenter.removeObserver(self, name: UIApplication.didBecomeActiveNotification, object: nil)
...
extension ScheduledLocationManager: CLLocationManagerDelegate {
    ...
    public func locationManager(_ manager: CLLocationManager, didUpdateLocations locations: [CLLocation]) {
        ...
        guard checkLocationTimer == nil else {
            ...
            print("checkLocationTimer == nil --> true")
            return
        }
